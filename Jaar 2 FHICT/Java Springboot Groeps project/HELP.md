...
* The following dependencies are not known to work with Spring Native: 'Spring Boot DevTools, MS SQL Server Driver'. As
...
```
$ docker run --rm -p 8080:8080 MedicijnBewaking:0.0.1-SNAPSHOT
```
